...
namespace Repositories.Migrations
{
    ...
    [Migration("20250331165755_AddedKullanicilarMenuSeedsUpdatedSeedRootMenu")]
    partial class AddedKullanicilarMenuSeedsUpdatedSeedRootMenu
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApiService.Entities.Concrete.AppEntities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2025, 3, 31, 19, 57, 55, 500, DateTimeKind.Local).AddTicks(6197),
                            CreatedUserName = "Seed Data",
                            EmailConfirmed = true,
                            FalseEntryCount = 0,
                            IsActive = true,
                            IsBlocked = false,
                            ModifiedDate = new DateTime(2025, 3, 31, 19, 57, 55, 500, DateTimeKind.Local).AddTicks(6200),
            ...
            modelBuilder.Entity("Core.Entities.Concrete.AppEntities.AppApplicationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApplicationName = "MVC",
                            CreatedDate = new DateTime(2025, 3, 31, 16, 57, 55, 496, DateTimeKind.Utc).AddTicks(9021),
                            CreatedUserName = "SeedData",
                            IsActive = true,
                            ModifiedDate = new DateTime(2025, 3, 31, 16, 57, 55, 496, DateTimeKind.Utc).AddTicks(9438),
            ...
            modelBuilder.Entity("Core.Entities.Concrete.AppEntities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2025, 3, 31, 19, 57, 55, 500, DateTimeKind.Local).AddTicks(496),
                            CreatedUserName = "Seed Data",
                            IsActive = true,
                            ModifiedDate = new DateTime(2025, 3, 31, 19, 57, 55, 500, DateTimeKind.Local).AddTicks(499),
            ...
            modelBuilder.Entity("Core.Entities.Concrete.AppEntities.AppRoleClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClaimId = 1,
                            CreatedDate = new DateTime(2025, 3, 31, 16, 57, 55, 499, DateTimeKind.Utc).AddTicks(7662),
                            CreatedUserName = "SeedData",
                            IsActive = true,
                            ModifiedDate = new DateTime(2025, 3, 31, 16, 57, 55, 499, DateTimeKind.Utc).AddTicks(7663),
                            ModifiedUserName = "SeedData",
                            RoleId = 1
                        },
                        new
                        {
                            Id = 2,
                            ClaimId = 2,
                            CreatedDate = new DateTime(2025, 3, 31, 16, 57, 55, 499, DateTimeKind.Utc).AddTicks(7960),
                            CreatedUserName = "SeedData",
                            IsActive = true,
                            ModifiedDate = new DateTime(2025, 3, 31, 16, 57, 55, 499, DateTimeKind.Utc).AddTicks(7960),
                            ModifiedUserName = "SeedData",
                            RoleId = 1
                        },
                        new
                        {
                            Id = 3,
                            ClaimId = 3,
                            CreatedDate = new DateTime(2025, 3, 31, 16, 57, 55, 499, DateTimeKind.Utc).AddTicks(7962),
                            CreatedUserName = "SeedData",
                            IsActive = true,
                            ModifiedDate = new DateTime(2025, 3, 31, 16, 57, 55, 499, DateTimeKind.Utc).AddTicks(7962),
                            ModifiedUserName = "SeedData",
                            RoleId = 1
                        },
                        new
                        {
                            Id = 4,
                            ClaimId = 4,
                            CreatedDate = new DateTime(2025, 3, 31, 16, 57, 55, 499, DateTimeKind.Utc).AddTicks(7964),
                            CreatedUserName = "SeedData",
                            IsActive = true,
                            ModifiedDate = new DateTime(2025, 3, 31, 16, 57, 55, 499, DateTimeKind.Utc).AddTicks(7964),
                            ModifiedUserName = "SeedData",
                            RoleId = 1
                        },
                        new
                        {
                            Id = 5,
                            ClaimId = 5,
                            CreatedDate = new DateTime(2025, 3, 31, 16, 57, 55, 499, DateTimeKind.Utc).AddTicks(7966),
                            CreatedUserName = "SeedData",
                            IsActive = true,
                            ModifiedDate = new DateTime(2025, 3, 31, 16, 57, 55, 499, DateTimeKind.Utc).AddTicks(7966),
                            ModifiedUserName = "SeedData",
                            RoleId = 1
                        },
                        new
                        {
                            Id = 6,
                            ClaimId = 6,
                            CreatedDate = new DateTime(2025, 3, 31, 16, 57, 55, 499, DateTimeKind.Utc).AddTicks(7969),
                            CreatedUserName = "SeedData",
                            IsActive = true,
                            ModifiedDate = new DateTime(2025, 3, 31, 16, 57, 55, 499, DateTimeKind.Utc).AddTicks(7970),
                            ModifiedUserName = "SeedData",
                            RoleId = 1
                        });
                });
            ...
            modelBuilder.Entity("Core.Entities.Concrete.AppEntities.AppUserRoles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2025, 3, 31, 19, 57, 55, 500, DateTimeKind.Local).AddTicks(3117),
                            CreatedUserName = "Seed Data",
                            IsActive = true,
                            ModifiedDate = new DateTime(2025, 3, 31, 19, 57, 55, 500, DateTimeKind.Local).AddTicks(3120),
                            RoleId = 1,
                            UserId = 1
                        });
                });
            ...
            modelBuilder.Entity("Entities.Concrete.AppEntities.AppClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 3, 31, 16, 57, 55, 497, DateTimeKind.Utc).AddTicks(8663),
                            CreatedUserName = "SeedData",
                            IsActive = true,
                            ModifiedDate = new DateTime(2025, 3, 31, 16, 57, 55, 497, DateTimeKind.Utc).AddTicks(8664),
                            ModifiedUserName = "SeedData"
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 3, 31, 16, 57, 55, 497, DateTimeKind.Utc).AddTicks(8996),
                            CreatedUserName = "SeedData",
                            IsActive = true,
                            ModifiedDate = new DateTime(2025, 3, 31, 16, 57, 55, 497, DateTimeKind.Utc).AddTicks(8997),
                            ModifiedUserName = "SeedData"
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 3, 31, 16, 57, 55, 497, DateTimeKind.Utc).AddTicks(8999),
                            CreatedUserName = "SeedData",
                            IsActive = true,
                            ModifiedDate = new DateTime(2025, 3, 31, 16, 57, 55, 497, DateTimeKind.Utc).AddTicks(8999),
                            ModifiedUserName = "SeedData"
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 3, 31, 16, 57, 55, 497, DateTimeKind.Utc).AddTicks(9001),
                            CreatedUserName = "SeedData",
                            IsActive = true,
                            ModifiedDate = new DateTime(2025, 3, 31, 16, 57, 55, 497, DateTimeKind.Utc).AddTicks(9001),
                            ModifiedUserName = "SeedData"
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 3, 31, 16, 57, 55, 497, DateTimeKind.Utc).AddTicks(9003),
                            CreatedUserName = "SeedData",
                            IsActive = true,
                            ModifiedDate = new DateTime(2025, 3, 31, 16, 57, 55, 497, DateTimeKind.Utc).AddTicks(9003),
                            ModifiedUserName = "SeedData"
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 3, 31, 16, 57, 55, 497, DateTimeKind.Utc).AddTicks(9007),
                            CreatedUserName = "SeedData",
                            IsActive = true,
                            ModifiedDate = new DateTime(2025, 3, 31, 16, 57, 55, 497, DateTimeKind.Utc).AddTicks(9007),
                            ModifiedUserName = "SeedData"
                        });
                });
            ...
            modelBuilder.Entity("Core.Entities.Concrete.AppEntities.AppMVCMenus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AppClaimId = 2,
                            CreatedDate = new DateTime(2025, 3, 31, 19, 57, 55, 498, DateTimeKind.Local).AddTicks(3898),
                            CreatedUserName = "Seed Data",
                            IsActive = true,
                            MenuDescription = "Sınav Base menü",
                            MenuName = "Sınav",
                            ModifiedDate = new DateTime(2025, 3, 31, 19, 57, 55, 499, DateTimeKind.Local).AddTicks(1704),
                            ActionName = "",
                            AreaName = "",
                            ControllerName = "",
                            IsNewTab = false,
                        ...
                        new
                        {
                            ...
                            AppApplicationTypeId = 1,
                            AppClaimId = 3,
                            CreatedDate = new DateTime(2025, 3, 31, 19, 57, 55, 499, DateTimeKind.Local).AddTicks(3431),
                            CreatedUserName = "Seed Data",
                            IsActive = true,
                            MenuDescription = "Sınav Kartlarını Görüntüle ",
                            MenuName = "Sınav Kartları",
                            ModifiedDate = new DateTime(2025, 3, 31, 19, 57, 55, 499, DateTimeKind.Local).AddTicks(3433),
                            ActionName = "Index",
                            AreaName = "Admin",
                        ...
                        new
                        {
                            ...
                            AppApplicationTypeId = 1,
                            AppClaimId = 4,
                            CreatedDate = new DateTime(2025, 3, 31, 19, 57, 55, 499, DateTimeKind.Local).AddTicks(3437),
                            CreatedUserName = "Seed Data",
                            IsActive = true,
                            MenuDescription = "Admin Modül Root menü",
                            MenuName = "Admin Modül",
                            ModifiedDate = new DateTime(2025, 3, 31, 19, 57, 55, 499, DateTimeKind.Local).AddTicks(3438),
                            ActionName = "",
                            AreaName = "",
                            ControllerName = "",
                            IsNewTab = false,
                        ...
                        new
                        {
                            ...
                            AppApplicationTypeId = 1,
                            AppClaimId = 5,
                            CreatedDate = new DateTime(2025, 3, 31, 19, 57, 55, 499, DateTimeKind.Local).AddTicks(3441),
                            CreatedUserName = "Seed Data",
                            IsActive = true,
                            MenuDescription = "Kullanıcılar",
                            MenuName = "Admin Modül - Kullanıcı",
                            ModifiedDate = new DateTime(2025, 3, 31, 19, 57, 55, 499, DateTimeKind.Local).AddTicks(3441),
                            ActionName = "",
                            AreaName = "",
                            ControllerName = "",
                            IsNewTab = false,
